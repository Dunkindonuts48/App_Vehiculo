...
suspend fun avgAggressivenessLastSessions(dao: DrivingSessionDao, vehicleId: Int, lastN: Int = 10): Float {
    val sessions = dao.getSessionsByVehicle(vehicleId).first().sortedByDescending { it.endTime }.take(lastN)
